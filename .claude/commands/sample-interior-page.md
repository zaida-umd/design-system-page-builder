...
<section class="umd-layout-space-vertical-interior">
  <h2 class="umd-layout-space-vertical-interior-child text-black umd-sans-larger-bold">Beanies</h2>
...
```html
<section class="umd-layout-space-vertical-interior">
  <h3 class="umd-layout-space-vertical-interior-child text-black umd-sans-larger-bold">Byrd Beach</h3>
...
```html
<section class="umd-layout-space-vertical-interior">
  <h3 class="umd-layout-space-vertical-interior-child text-black umd-sans-larger-bold">Class Wars</h3>
  <umd-element-media-inline>
...
```html
<section class="umd-layout-space-vertical-interior">
  <h3 class="umd-layout-space-vertical-interior-child text-black umd-sans-larger-bold">Kissing Tunnel</h3>
...
```html
<section class="umd-layout-space-vertical-interior">
  <h3 class="umd-layout-space-vertical-interior-child text-black umd-sans-larger-bold">May Day</h3>
  <umd-element-media-inline data-layout-alignment="right">
